...
let LinearProgress = class LinearProgress extends BaseElement {
    ...
    createAdapter() {
        return Object.assign({}, super.createAdapter(), { getPrimaryBar: () => this.primaryBar, getBuffer: () => this.bufferElement, setStyle: (el, property, value) => el.style[property] = value });
    }
    open() {
        this.closed = false;
    }
